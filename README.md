...
A [Camunda Modeler](https://github.com/camunda/camunda-modeler) Plugin for inspecting JSON object tree of a diagram.

![](./resources/screenshot.png)

This plugins displays the JSON representative of the diagram XML, generated by [`bpmn-moddle`](https://github.com/bpmn-io/bpmn-moddle/). For those who ❤️ JSON and 👎🏻 XML.
